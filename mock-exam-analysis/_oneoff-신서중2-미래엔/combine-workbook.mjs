...
const LESSONS = {
  L5: {
    ...
    docTitle: '신서중 2학년 · 미래엔 Lesson 5 워크북 합본 — Terra Nova',
    out: '신서중2_미래엔_Lesson5_워크북_합본.pdf',
  },
  L6: {
    source: SOURCE_L6,
    lessonNo: 6,
    ...
    docTitle: '신서중 2학년 · 미래엔 Lesson 6 워크북 합본 — Terra Nova',
    out: '신서중2_미래엔_Lesson6_워크북_합본.pdf',
  },
};
