#!/usr/bin/env node
/* ===================================================================
 * 신서중2 미래엔(문영인) — 무결성 검증 (문장 누락 0 보장)
 * ===================================================================
 ...
 *   node _oneoff-신서중2-미래엔/verify.mjs L6     # 특정 과만
 * =================================================================== */
...
const LESSONS = [
  { id: 'L5', label: 'Lesson 5 · My Hometown, Chuncheon',      source: SOURCE_L5 },
  { id: 'L6', label: 'Lesson 6 · My First Skateboarding Lesson', source: SOURCE_L6 },
];
...
console.log('🔍 신서중2 미래엔(문영인) — 무결성 검증\n');
