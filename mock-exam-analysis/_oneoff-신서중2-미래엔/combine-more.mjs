#!/usr/bin/env node
/* ===================================================================
 * 신서중2 미래엔 — More Reading(추가지문) 본문분석 합본
 * ===================================================================
 * combine.mjs(L5/L6용)를 그대로 복제해 MR5/MR6(각 1챕터)용으로 조정.
 * dist/{MR5,MR6}/1.html 의 .page 섹션을 표지 + 본문 전문 페이지와 이어붙여
 * 단일 PDF 로 만든다. 페이지 번호는 합본 전체 기준 1부터 재부여.
 *
 * 사용법:
 *   node _oneoff-신서중2-미래엔/combine-more.mjs MR5
 *   node _oneoff-신서중2-미래엔/combine-more.mjs MR6
 * =================================================================== */
...
const LESSONS = {
  MR5: {
    ...
    coverSub: '미래엔(문영인) 중학교 영어 2<br>Lesson 5-⑦ More Reading',
    docTitle: '신서중 2학년 · 미래엔 Lesson 5-⑦ More Reading 본문분석 — Terra Nova',
    out: '신서중2_미래엔_Lesson5-More Reading_본문분석.pdf',
  },
  MR6: {
    source: SOURCE_MR6,
    coverTitle: '신서중 2학년<br>미래엔 영어 2',
    titleEn: 'A New Challenge on the Climbing Wall',
    coverSub: '미래엔(문영인) 중학교 영어 2<br>Lesson 6-⑥ More Reading',
    docTitle: '신서중 2학년 · 미래엔 Lesson 6-⑥ More Reading 본문분석 — Terra Nova',
    out: '신서중2_미래엔_Lesson6-More Reading_본문분석.pdf',
  },
};
