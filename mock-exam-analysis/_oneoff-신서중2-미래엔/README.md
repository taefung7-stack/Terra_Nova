...
| 과 | 본문분석 합본 | 워크북 합본 |
|----|---------------|-------------|
| L5 | `신서중2_미래엔_Lesson5_본문분석_합본.pdf` — 표지1+목차1+본문12 = **14p** | `신서중2_미래엔_Lesson5_워크북_합본.pdf` — **29p** |
| L6 | `신서중2_미래엔_Lesson6_본문분석_합본.pdf` — 표지1+목차1+본문14 = **16p** | `신서중2_미래엔_Lesson6_워크북_합본.pdf` — **38p** |
