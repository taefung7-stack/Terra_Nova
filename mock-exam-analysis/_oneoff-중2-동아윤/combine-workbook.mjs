 ...
 *
 * 사용법:
 *   node _oneoff-신서고-YBM-L1/combine-workbook.mjs <L1|L2> [출력파일명.pdf]
 * =================================================================== */
...
const LESSONS = {
  L5: {
    ...
    docTitle: '중2 · 동아(윤정미) Lesson 5 워크북 합본 — Terra Nova',
    out: '중2_동아윤정미_Lesson5_워크북_합본.pdf',
  },
  L6: {
    source: SOURCE_L6,
    lessonNo: 6,
    ...
    docTitle: '중2 · 동아(윤정미) Lesson 6 워크북 합본 — Terra Nova',
    out: '중2_동아윤정미_Lesson6_워크북_합본.pdf',
  },
};
...
<head>
<meta charset="utf-8">
<title>${LESSON.docTitle ?? `중2 · 동아(윤정미) Lesson ${LESSON.lessonNo} 워크북 합본 — Terra Nova`}</title>
