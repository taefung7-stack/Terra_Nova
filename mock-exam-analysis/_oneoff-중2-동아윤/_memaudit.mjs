...
const TEXTBOOK = {
  L5: [
    `Modern street art comes in many different forms, and it makes cities colorful and lively. Today, we are going to see some well-known street artworks in London.`,
    `The place that we are going to visit is Shoreditch. Poor workers used to live in this area, but now it is one of the hippest areas in London. We can find so many great pieces of street art here. Do you see the painting over there? It is by the artist STIK. He is famous for using only lines and dots in his paintings of human bodies. According to STIK, the three figures represent the past, present, and future of Shoreditch. Which figure represents which? Well, look closely at the eyes of the three figures. They are just dots, but they will give you a clue.`,
    `We are now in Finsbury Park to see a painting by Banksy, an internationally famous street artist. Banksy's artworks often carry social messages, and the green tree you see over there is a good example. As you can see, he created a green tree by spraying green paint on a wall behind a leafless tree. Next to the tree, there is a person who is holding a sprayer. What message does Banksy want to give us through this painting? In many people's opinion, he is telling us that nature is having a hard time. They think he wants us to take better care of it.`,
    `The final stop of our tour today is Muswell Hill. Can't see any street artworks? Well, look down and look closely. Do you see the little chewing gum paintings? They are by the artist Ben Wilson. Wilson is well known for painting pictures on gum that people drop on the street. His gum paintings often carry personal messages from people he meets on the street. For example, the one over here is a happy birthday wish for a loved one. Wilson's gum paintings are tiny, but they give great pleasure to many people.`,
  ],
  L6: [
    `On February 28, 1919, a man came to Dr. Schofield's house.`,
    `Dr. Schofield, I have a special favor to ask you.`,
    `What can I do for you?`,
    `Many people are going to gather tomorrow for the independence of Korea. Could you take pictures of the event and share them with the world?`,
    `At 2 p.m. on March 1, Dr. Schofield was hiding in a building and saw a large group of people gathering outside. He began to take pictures.`,
    `Unbelievable! There are so many people here. I hope the world will learn about this important event through my pictures.`,
    `Do you know Seok Hopil? His English name was Frank W. Schofield, but he loved his Korean name. It sounded similar to his real name, and it also had a good meaning.`,
    `Dr. Schofield was a Canadian doctor, and he first came to Korea in 1916 to teach medicine. He wanted to teach in Korean, so he began to learn Korean right away. He studied so hard that he was able to teach in Korean after only a few years. He believed that every country has the right to be independent, so he helped the Korean independence movement.`,
    `On March 1, 1919, Dr. Schofield heard people shouting for Korean independence in Tapgol Park. He took pictures of the event with his camera. He then wrote an article about the historic event and sent it to foreign newspapers with his pictures.`,
...
function splitSentences(para) {
  ...
  for (let i = 0; i < para.length; i++) {
    ...
    if (/[.!?]/.test(para[i])) {
      ...
      /* ★ 약어의 마침표는 문장 끝이 아니다 — Dr. Schofield / Frank W. Schofield /
         2 p.m. 를 문장 경계로 보면 26문장이 35문장으로 쪼개진다(실제로 겪음). */
      if (/(^|[\s("'])(Dr|Mr|Mrs|Ms|St|Jr|Sr|vs|etc|[A-Z]|a\.m|p\.m)\.$/.test(buf)) continue;
