 ...
 *
 * 사용법:
 *   node _oneoff-신목고-세계문학/combine.mjs <U1> [출력파일명.pdf]
 * =================================================================== */
...
/** 정본 → 합본용 평탄화 (verify.mjs 와 동일 규칙).
 *  게시글 문장 + 댓글 문장을 이어붙인 것이 그 챕터의 본문이다. */
...
<head>
<meta charset="utf-8">
<title>${LESSON.docTitle ?? `신목고 2-2 중간 · 세계문학 본문분석 합본 — Terra Nova`}</title>
