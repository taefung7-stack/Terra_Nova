#!/usr/bin/env node
/* ===================================================================
 * 변형문제 정답 분포 재조정 (신목고 세계문학 U1 · 4지문)
 * -------------------------------------------------------------------
 * 문제: theme·gist·title·implication·blank·summary 6개 유형이 4지문 전부 ①,
 *       irrelevant 는 4지문 전부 ④ 였다. 44문항 중 ①이 24개(54.5%).
 *       주제·요지·제목을 전부 ①로 찍으면 만점이 나오는 상태였다.
